...
const dict: Record<string, { id: string; en: string }> = {
  ...
  'impact.weak.title': { id: '⚠️ Dampak Pelemahan Rupiah untuk Anda', en: '⚠️ Impact of Rupiah Weakening on You' },
  'impact.strong.title': { id: '📈 Dampak Penguatan Rupiah untuk Anda', en: '📈 Impact of Rupiah Strengthening on You' },
  'impact.weak.import': { id: 'Harga barang impor naik — elektronik, obat, bahan baku industri tambah mahal', en: 'Import prices rise — electronics, medicine, and industrial raw materials get more expensive' },
  'impact.weak.travel': { id: 'Biaya pendidikan & wisata luar negeri — makin mahal karena dolar naik', en: 'Education & overseas travel costs — more expensive as dollar rises' },
  'impact.weak.inflation': { id: 'Inflasi tertahan — harga barang dalam negeri ikut tertekan naik', en: 'Inflation persists — domestic goods prices also pressured upward' },
  'impact.weak.export': { id: 'Positif: eksportir diuntungkan — hasil jualannya lebih bernilai', en: 'Positive: exporters benefit — their products are worth more' },
  'impact.strong.purchasing': { id: 'Daya beli masyarakat terjaga — harga barang impor lebih murah', en: 'Public purchasing power maintained — imported goods cheaper' },
  'impact.strong.travel': { id: 'Biaya luar negeri lebih murah — liburan, kuliah, atau bisnis ke luar negeri', en: 'Overseas costs cheaper — travel, study, or business abroad' },
  'impact.strong.inflation': { id: 'Inflasi lebih terkendali', en: 'Inflation is more controlled' },
  'banner.hey': { id: 'Catatan', en: 'Note' },
  'banner.text': { id: 'Website ini dikembangkan sebagai bentuk kepedulian terhadap kondisi ekonomi Indonesia saat ini. Silakan sebarkan informasi ini kepada siapa pun yang membutuhkan gambaran nyata kondisi Rupiah dan perekonomian Indonesia. Jika Anda merasa proyek ini bermanfaat, Anda dapat mendukung melalui tombol donasi di bawah. Kami akan terus mengembangkan proyek-proyek lain yang memberikan literasi ekonomi dan politik kepada masyarakat. Nantikan proyek-proyek selanjutnya.', en: 'This website was developed as a form of concern for Indonesia\'s current economic conditions. Please share this information with anyone who needs a realistic picture of the Rupiah and Indonesia\'s economy. If you find this project valuable, you can support it through the donation button below. We will continue developing other projects that provide economic and political literacy to the public. Stay tuned for upcoming projects.' },
  'prediction.disclaimer': { id: '⚠️ Disclaimer', en: '⚠️ Disclaimer' },
  'prediction.disclaimer.text': { id: 'Prediksi ini berdasarkan model statistik sederhana (EWMA regression) dan data historis. Makin jauh horizon, makin tinggi ketidakpastian. Prediksi 1 tahun hanya menunjukkan arah jika tren saat ini berlanjut tanpa intervensi — yang di dunia nyata hampir pasti tidak terjadi. Faktor seperti intervensi BI, perubahan kebijakan The Fed, harga komoditas, dan stabilitas politik dapat mengubah arah secara drastis.', en: 'This prediction is based on a simple statistical model (EWMA regression) and historical data. The farther the horizon, the higher the uncertainty. 1-year predictions only indicate direction if the current trend continues without intervention — which in reality almost certainly will not happen. Factors such as BI intervention, Fed policy changes, commodity prices, and political stability can drastically alter the trajectory.' },
  'prediction.disclaimer.financial': { id: 'Bukan rekomendasi finansial. Jangan digunakan untuk trading atau keputusan investasi.', en: 'Not financial advice. Do not use for trading or investment decisions.' },
