    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="rounded-lg border border-yellow-300 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-950/40 p-4 mb-6 text-sm text-yellow-800 dark:text-yellow-200 leading-relaxed">
          <strong>Note!</strong> Teruntuk bang Andri TNM, gua bikin engine ini atas dasar kemarahan gua terhadap rezim sekarang, jadi bantu viralkan — (note ini hanya sementara ntar gua hapus lagi bang, cuman buat lu) sekaligus minta semua subscriber lu yang kaya raya itu buat bantu gua dengan cara donate lewat tombol donate dibawah di footer kalo lu pikir project ini bagus, karena gua mau bikin banyak project/produk yang bakal terasa nyindir pemerintah, bikin banyak produk terkait ekonomi dan politik saat ini untuk rakyat, ntar gua juga kalo launch project baru bakal gua kasih ke lu juga
        </div>
        <ErrorBoundary>
          {children}
        </ErrorBoundary>
